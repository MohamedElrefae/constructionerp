...
| Candidate commit (code + evidence) | `c19c7bf` — last commit that changed code, data, or release evidence; on origin/develop |
| Remote baseline | `338baba7a6cd248742019195a401546b7933aef4` → `c19c7bf` on origin/develop |
| Deployed release candidate | `c19c7bf` on `origin/develop` |
| Doc-only sync commits (excluded) | `8c72efb`, `d140569`, `160f31b`, `703e756`, `031a857` — sign-off documentation edits only; no code/data/evidence change |
