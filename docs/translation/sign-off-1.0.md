...
| Application scope | Frappe 16.18.1 (81aadb9), ERPNext 16.18.3 (2807c9f), Construction 0.0.5 (8c72efb) |
| Catalog snapshot | 15,122 Arabic source strings (15106 + 15 payload-driven + 1 corrected case) |
| Glossary | v2.0, schema v2, 47 terms |
| Candidate commit | `8c72efb` (was bc59bf2) — 10 commits ahead of 338baba, now pushed to origin/develop |
| Remote baseline | `338baba7a6cd248742019195a401546b7933aef4` → `8c72efb` on origin/develop |
...
| B-10 | P1 | Candidate local only (2 ahead). | Pushed to `origin/develop` — `8c72efb` now on remote; `git status` shows `## develop...origin/develop` clean. | **FIXED** |
...
Evidence captured on 2026-09-02 against `v16.localhost` after remediation (8c72efb):
...
| Release authority | Confirms all gates, deployed commit, backup, smoke | A1/A2/A3 ready, commit 8c72efb on origin, backup 104925 (final, DB unchanged from bc59bf2) | **Open — awaiting signature** |  |
...
Current evidence (2026-09-02 12:55, re-verified 2026-09-02 14:45, HEAD 8c72efb) shows all of the above:
...
- `## develop...origin/develop` (8c72efb clean, pushed)
...
|---|---|---|---|---|
| Release Authority | | | `8c72efb` on `origin/develop` | `docs/evidence/translation-stabilization-20260902_104925-manifest.json` SHA256 `53043217f85b3f6d1915fa7955f6a7960700f48b7af4fde6ce9865d71c6b9b71` (final, DB unchanged) |
