"""Read-only live Translation reconciliation for proposed W6-6 Assets scope."""
...
SITE = "v16.localhost"
SCOPE = ROOT / "docs/translation/stage6_w606_assets_rows_2026-09-24.csv"
OUT = ROOT / "docs/translation/stage6_w606_assets_site_recon_2026-09-24.json"
...
assert len(keys) == 211 and len(set(keys)) == 211
...
try:
    ...
    payload = {
        ...
        "note": "Read-only exact normalized runtime lookup reconciliation for proposed W6-6 scope on the test site.",
    }
