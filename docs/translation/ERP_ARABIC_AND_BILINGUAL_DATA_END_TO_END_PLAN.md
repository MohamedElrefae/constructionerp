...
| 5 | Wave 1 masters (Item, Customer, Supplier, …) | 🟡 **Readiness recorded; data migration deferred by owner decision** — owner chose deferral to Stage 8 with real production masters (2026-09-20); Arabic fields installed (`item_name_ar`, `customer_name_in_arabic`, `supplier_name_in_arabic`), 0 values populated; bilingual search verified live on all three `schema_installed` doctypes; vendor `_Test*` fixtures excluded by governance; Cost Center/Warehouse/Project registry mappings deferred with the wave | 2026-09-20 | `docs/ai/work-items/scope-context-portability/evidence/stage5-wave1-readiness-2026-09-20.md` |
| 2, 6–8 | Remaining later stages | ✅ Stage 2: **operationally closed** (owner decision 2026-09-20) — full/scoped/vendor gates + 91/91 standalone tests + both lints + CI source gate all exit-0 at `b081b2e`; closure commit `6ab4ae7` is docs/evidence only. Re-pin deliberately deferred to the next real catalog change (Stage 6/7). Stages 6–8: 🔴 Not started | 2026-09-20 | `docs/ai/work-items/scope-context-portability/evidence/stage2-closure-verification-2026-09-20.md` |
