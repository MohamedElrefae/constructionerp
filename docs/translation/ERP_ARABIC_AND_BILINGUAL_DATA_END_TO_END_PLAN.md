...
| 6 | **W6-2 batch-02 — Buying+Selling remainder PROPOSAL FILED** (no quorum/import/re-pin): exact 48-row scope CSV `stage6_w602_batch02_rows_2026-09-23.csv` sha `9a096273f2f7ef05a403edffbb4b75604b73ce7f854382c8fd570f5c329e44ce` (48 selling = 1 pre-filled + 47 unfilled; 0 overlap vs catalog 2275 / batch01 270 / prior W6-0b / technical 21 / dedup 302). Raw accounting corrected: **337 = 268 (b01 in raw) + 48 (b02) + 21 residual** (`21 = 5 HTML + 15 len>120 + 1 already-released`, mutually exclusive; b01 file size 270 = 268 + 2 synthetic keys outside raw — do not use `270+48+20`). Awaiting owner approval of that exact CSV; evidence re-pin deferred to next catalog-changing cycle. Production Stage 8 still gated | 2026-09-23 | `stage6_w602_batch02_proposal_2026-09-23.md`; `stage6_w602_batch02_rows_2026-09-23.csv` |
...
| 2026-09-23 | **W6-2 batch-02 PROPOSAL ONLY filed** — exact 48-row CSV sha `9a096273…` presented for approval; **no quorum, no import, no catalog change, no evidence re-pin** until owner approves that exact scope. Scope accounting corrected for owner review: raw **337 = 268 + 48 + 21** (residual 21 = 5 HTML + 15 `len>120` + 1 already-released; mutually exclusive). Evidence re-pin deferred to the next catalog-changing cycle. Production Stage 8 still gated | `stage6_w602_batch02_proposal_2026-09-23.md` |

## 18. Hold state (owner directive, 2026-09-21; corrected 2026-09-22; W6-0b batch-7 update 2026-09-22; W6-2 batch-01 update 2026-09-23; W6-2 batch-02 proposal 2026-09-23)
...
- 2026-09-23: **W6-2 batch-02 PROPOSAL ONLY filed** — exact 48-row CSV
  `stage6_w602_batch02_rows_2026-09-23.csv` sha `9a096273…` presented for
  approval (48 selling = 1 pre-filled + 47 unfilled; 0 overlap vs catalog /
  batch 01 / prior W6-0b / technical / dedup). Scope accounting corrected:
  raw **337 = 268 + 48 + 21**; residual **21 = 5 HTML + 15 `len>120` + 1
  already-released** (mutually exclusive; batch-01 file 270 = 268 raw + 2
  synthetic keys outside raw). **No quorum, no import, no catalog change,
  no evidence re-pin** until owner approves that exact scope. Evidence
  re-pin deferred to the next catalog-changing cycle. Production still
  gated as above.
