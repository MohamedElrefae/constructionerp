...
1. **AI-R verifies exact commit `0433497`** (migration set, data hashes,
   tests, rollback evidence, evidence bundle).
...
- 2026-09-22: Isolated backup/restore **rehearsal drill CLOSED**
  ...
  Stage-2 evidence re-pinned on pre-commit HEAD `80787af`; commit `0433497`.
