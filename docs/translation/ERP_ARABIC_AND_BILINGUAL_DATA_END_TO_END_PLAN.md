...
| 2026-09-21 | Local-test transactions read for Stage 8 path (owner-posted EGP 10,000/4,000 JVs, invoice draft untouched): viewer GL date controls fixed (owner-reported), bilingual GL/TB and AR aging rendered live in the governed viewer with real rows; preflight run before evidence | `stage7-local-data-readiness-2026-09-21.md` |
