"""Read-only live Translation reconciliation for proposed W6-6 CRM, Support & Maintenance scope."""
...
OUT = ROOT / "docs/translation/stage6_w606_crm_support_maintenance_site_recon_2026-09-24.json"
...
try:
    ...
    print(f"Missing runtime keys: {len(missing_runtime)}")
