#!/usr/bin/env python3
"""W6-0b batch-3 scope cut — extract batch `03` from the committed batch plan.
...
OUT = ROOT / "stage6_w60b_batch03_rows_2026-09-22.csv"
BATCH = "03"
FIELDS = [
    "source_text",
    "classification",
...
EXPECTED_ROWS = 271
EXPECTED_SHA = "21ac507ede96f72e86e4825aca1a6888a5b38ca56ffed7c35682b16dc475a89a"
