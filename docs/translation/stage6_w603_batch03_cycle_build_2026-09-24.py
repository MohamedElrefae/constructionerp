"""Build W6-3 batch-03 catalog/disposition artifacts after quorum PASS.

This script modifies only repository release artifacts and never the Frappe
site. Run after proposal quorum PASS; AI-R must approve the resulting exact
bundle before the test-site import.
"""
...
PROPOSAL = HERE / "stage6_w603_proposal_batch03_2026-09-24.csv"
RECON = HERE / "stage6_w603_batch03_site_recon_2026-09-24.json"
PAYLOAD = HERE / "stage6_w603_payload_applied_rows_batch03_2026-09-24.csv"
RELEASED = HERE / "stage6_w603_batch03_released_list_2026-09-24.txt"
...
PROPOSAL_SHA = "0b9f7a86923b4c53fbf65dfa3d7b6bfbed2518fbfbbf5dedd2012c414bcb8025"
AI_A1 = "docs/ai/work-items/scope-context-portability/evidence/stage6-w603-ai-a1-batch03-2026-09-24.md"
AI_A2 = "docs/ai/work-items/scope-context-portability/evidence/stage6-w603-ai-a2-batch03-2026-09-24.md"
AI_A3 = "docs/ai/work-items/scope-context-portability/evidence/stage6-w603-ai-a3-batch03-2026-09-24.md"
REVIEWERS = (
...
def main() -> None:
    ...
    assert all(r["proposed_ar"] == "" for r in proposal if r["proposed_disposition"] == "EXCEPTION-technical")
    ...
    for r in proposal:
        ...
        if disp == "PROPOSED-payload":
            ...
            released_rows.append({
                ...
                "references": "glossary v2.0; vendor stock PO locations; plan D5; W6-3 batch-03",
    ...
    assert len(existing) == 2540 and len(released_rows) == 111
    ...
    doc["note"] = "W6-3 batch-03 additions bind quorum PASS to the exact proposal SHA; historical decisions retained."
