#!/usr/bin/env python3
"""W6-0b batch-5 site recon: list ar Translation rows for scope keys with ct_origin."""
...
OUT = ROOT / "docs/translation/stage6_w60b_batch05_site_recon_2026-09-22.json"
