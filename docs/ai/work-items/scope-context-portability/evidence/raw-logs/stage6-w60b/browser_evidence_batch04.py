#!/usr/bin/env python3
"""W6-0b batch-4 Arabic browser evidence (headless, ar Desk session)."""
...
PROBES = {
    ...
    # preserved site-override runtime keys (exact DB source_text casing)
...
with sync_playwright() as p:
    ...
    page.screenshot(path=str(OUT / "browser-ar-desk-batch04.png"), full_page=False)
...
(OUT / "browser_evidence_batch04.json").write_text(
