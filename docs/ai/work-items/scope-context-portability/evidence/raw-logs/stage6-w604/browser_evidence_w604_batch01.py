#!/usr/bin/env python3
"""Headless Arabic Desk verification for W6-4 batch-01; password via stdin."""
...
PROPOSAL = ROOT / "docs/translation/stage6_w604_proposal_2026-09-24.csv"
...
assert len(expected) == 144, len(expected)

results = {
    "batch": "stage6-w604-batch01",
    "site": "v16.localhost",
    "scope_sha256": "93fbf16b14940ce2d477f346c1777865bf008b22df943625e7de84f27e8f4abe",
    "proposal_sha256": "a9b9abaf3111b5ca0310aa7c3291f4c45e7fc04807242894848c707542694e2c",
...
with sync_playwright() as p:
    ...
    page.screenshot(path=str(OUT / "browser-ar-desk-w604-batch01.png"), full_page=False)
...
(OUT / "browser_evidence_w604_batch01.json").write_text(
