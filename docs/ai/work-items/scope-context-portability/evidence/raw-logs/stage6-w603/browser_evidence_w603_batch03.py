#!/usr/bin/env python3
"""Headless Desk verification for W6-3 batch-03; password via stdin."""
...
PROPOSAL = ROOT / "docs/translation/stage6_w603_proposal_batch03_2026-09-24.csv"
...
assert len(expected) == 232, len(expected)

results = {
    "batch": "stage6-w603-batch03",
    "site": "v16.localhost",
    "scope_sha256": "a5f0e9f604ea52d89072d2c744864fdcbc733bc8307fd427a5c2658f4855dbc9",
    "proposal_sha256": "0b9f7a86923b4c53fbf65dfa3d7b6bfbed2518fbfbbf5dedd2012c414bcb8025",
...
with sync_playwright() as p:
    ...
    page.screenshot(path=str(OUT / "browser-ar-desk-w603-batch03.png"), full_page=False)
...
(OUT / "browser_evidence_w603_batch03.json").write_text(
