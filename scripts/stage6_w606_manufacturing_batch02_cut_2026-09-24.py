"""Deterministically cut the proposal-only W6-6 Manufacturing batch 02 (remainder)."""
...
OUTPUT = ROOT / "docs/translation/stage6_w606_manufacturing_batch02_rows_2026-09-24.csv"
MAX_LEN = 120
...
def main() -> None:
    ...
    print(f"Eligible: {len(eligible)}, Blocked/Covered: {len(overlap)}, Fresh remainder: {len(fresh)}")
    ...
    print(f"batch02={len(output_rows)}")
    print(
        "batch02_prefilled="
