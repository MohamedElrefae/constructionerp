...
app_include_css = [
    ...
    "/assets/construction/css/vite_extensions.css?v=1.0",
    "/assets/construction/css/vite_form_override.css?v=1.0",
    "/assets/construction/css/vite_list_override.css?v=1.0",
]
...
app_include_js = [
	...
	"/assets/construction/js/vite_layout_controls.js?v=1.0",
]
