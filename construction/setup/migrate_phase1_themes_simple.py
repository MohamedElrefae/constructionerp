    ...
    for theme_data in FIXTURE_THEMES:
        ...
        try:
            ...
            if exists:
                ...
                """, (
                    theme_name, theme_name, theme_data["emoji_icon"],
                    theme_data["is_active"], theme_data["theme_type"],
                    theme_data["is_system_theme"], theme_data["is_default_light"],
                    theme_data["is_default_dark"], theme_data["accent_primary"],
                    theme_data["accent_primary_hover"], theme_data["accent_secondary"],
                    theme_data["navbar_bg"], theme_data["sidebar_bg"],
                    theme_data["surface_bg"], theme_data["body_bg"],
                    theme_data["text_primary"], theme_data["text_secondary"],
                    theme_data["border_color"], theme_data["success_color"],
                    theme_data["warning_color"], theme_data["error_color"],
                    theme_data["preview_colors"], theme_data["description"],
                    theme_data["contrast_ratio"]
                ))
                created_count += 1
