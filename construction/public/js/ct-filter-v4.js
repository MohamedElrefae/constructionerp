...
function enforce(){
  ...
  var bg=getComputedStyle(document.documentElement).getPropertyValue('--ct-bg-elevated').trim()||'#111827';
  var tx=getComputedStyle(document.documentElement).getPropertyValue('--ct-text').trim()||'#f8fafc';
  var t2=getComputedStyle(document.documentElement).getPropertyValue('--ct-text-secondary').trim()||'#94a3b8';
  var br=getComputedStyle(document.documentElement).getPropertyValue('--ct-border').trim()||'rgba(148,163,184,0.18)';
  var pr=getComputedStyle(document.documentElement).getPropertyValue('--ct-primary').trim()||'#2563eb';
  ...
  f('.page-form .standard-filter-section,.page-form .filter-section,.page-form .filter-area,.page-form .frappe-control,.page-form .frappe-control .control-input,.page-form .frappe-control .control-input-wrapper,.page-form .link-field,.page-form .link-field.ui-front,.page-form .input-group,.page-form .filter-field,.page-form .awesomplete').forEach(function(e){
  ...
  f('.page-form select,.page-form select.form-control,.page-form input.form-control,.page-form input.input-with-feedback,.page-form .link-field input,.page-form .multiselect-list .form-control,.page-form .awesomplete input,.page-form input[data-fieldtype="Date"],.page-form input.hasDatepicker').forEach(function(e){
  ...
  f('.page-form .frappe-control .select-icon,.page-form .frappe-control .select-icon svg,.page-form .frappe-control .select-icon use,.page-form .frappe-control .placeholder').forEach(function(e){
    e.style.setProperty('display','none','important');
  });

  // Fix 5: Buttons unified
  f('.page-form .filter-selector,.page-form .filter-selector .btn,.page-form .filter-button,.page-form [data-action="add-filter"]').forEach(function(e){
    e.style.setProperty('height','30px','important');
...
[0,500,1500,3000,5000,8000].forEach(function(d){setTimeout(enforce,d);});
var o=new MutationObserver(function(){setTimeout(enforce,50);});
setTimeout(function(){
