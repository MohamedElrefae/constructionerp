...
(function () {
    ...
    console.log("%c[Construction Theme Patch] v5.0 Native Architecture...", "color: #3b82f6; font-weight: bold; font-size: 14px;");

    // ── PATCH A: Neutralise frappe.ui.Theme.prototype.set_theme ──────────────
    function patchThemePrototype() {
        if (window.frappe && window.frappe.ui && window.frappe.ui.Theme && window.frappe.ui.Theme.prototype) {
    ...
    function patchThemeSwitcher() {
        if (window.frappe && window.frappe.ui && window.frappe.ui.ThemeSwitcher) {
            ...
            window.frappe.ui.ThemeSwitcher.prototype.refresh = function () {
                ...
                this.current_theme = currentMode === "dark" ? "construction_dark" : "construction_light";
