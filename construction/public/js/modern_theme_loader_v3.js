		...
		if (!frappe.ui.ThemeSwitcher) {
				...
				switch_theme(theme_name) {
					...
					if (theme_name === "dark") {
						...
						if (theme && theme.is_construction) {
							...
							targetMode =
								theme_name.toLowerCase().indexOf("dark") !== -1 ? "dark" : "light";
						}
					}
			...
			OriginalThemeSwitcher.prototype.switch_theme = function (theme_name) {
				...
				if (theme && theme.is_construction) {
					...
					console.log(
						"[Modern Theme] Construction theme detected:",
						themeDoc,
						"mode:",
						targetMode
					);
