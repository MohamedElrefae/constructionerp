	...
	if (!wrap) {
		const section = frm.dashboard.add_section(
			[
				...
				'<div class="ct-bi-row"><b>' +
					__("English") +
					':</b> <span class="ct-bi-en"></span></div>',
				'<div class="ct-bi-row"><b>' +
					__("Arabic") +
					':</b> <span class="ct-bi-ar"></span> ',
				'<button class="btn btn-xs btn-default ct-bi-edit-ar">' +
					__("Edit Arabic") +
					"</button></div>",
				'<div class="ct-bi-row"><b>' +
					__("Code") +
					':</b> <span class="ct-bi-code"></span></div>',
				'<div class="ct-bi-row"><b>' +
					__("Preview") +
					':</b> <span class="ct-bi-preview"></span></div>',
				'<div class="ct-bi-row"><b>' +
					__("Completeness") +
					':</b> <span class="ct-bi-complete"></span></div>',
		...
		[
			{
				...
				fieldtype: "Data",
				label: __("New English account name"),
				default: ident.english || "",
				reqd: 1,
			},
			{
				fieldname: "account_number",
				fieldtype: "Data",
				label: __("New account number"),
				default: ident.code || "",
			},
			{
				fieldname: "reason",
				fieldtype: "Small Text",
				label: __("Reason (required, recorded)"),
				reqd: 1,
			},
		],
		function (values) {
