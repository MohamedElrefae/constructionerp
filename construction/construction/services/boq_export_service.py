...
class BOQExportService:
    ...
    def get_tree_data(boq_header: str) -> List[Dict]:
        ...
        structures = frappe.get_all(
            ...
            fields=["name", "wbs_code", "title", "is_group", 
        ...
        items = frappe.get_all(
            "BOQ Item",
            filters={"boq_header": boq_header},
            fields=["structure", "quantity", "unit", "contract_unit_price", 
                   "line_total", "owner_page", "owner_ref_no", "owner_file_ref"]
        )
    ...
    def export_to_excel(boq_header: str) -> Dict:
        ...
        try:
            ...
            # Define headers
            headers = [
                "WBS Code", "Title", "Type", "Unit", "Quantity",
                "Unit Price", "Factor", "Line Total",
                "Owner Page", "Owner Ref No", "Owner File Ref"
            ]
    ...
    def get_section_rollup(structure_name: str) -> float:
        ...
        try:
            ...
            frappe.log_error(f"Rollup calculation error: {str(e)}")
            return 0