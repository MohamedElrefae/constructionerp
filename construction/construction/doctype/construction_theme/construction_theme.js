    ...
    onload: function(frm) {
                ...
                fields: [
                    {
                        ...
                        options: `
                            ...
                            <div style="margin-top: 10px; color: var(--text-muted);">
                                ${__('Preview shows approximate rendering. Save and apply theme to see full effect.')}
                            </div>
                        `
                    }
                ],
        ...
        frm.update_preview_colors = function() {
            ...
            var swatches = colors.map(function(c) {
                return '<span style="display:inline-block;width:20px;height:20px;background:' + c + ';border-radius:4px;margin-right:4px;border:1px solid #ddd;"></span>';
            }).join('');
            ...
            if (existing.length) {
                ...
                frm.page.wrapper.find('.page-head .page-title').append(
                    '<span class="theme-preview-swatches" style="margin-left:15px;vertical-align:middle;">' + swatches + '</span>'
                );
            }
        };
    }
