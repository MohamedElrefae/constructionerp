...
function buildHierarchyHTML(tree) {
	...
	for (var ci = 0; ci < tree.length; ci++) {
		...
		if (c.cost_centers.length) {
			...
			parts.push(
				'<div style="font-weight:500;margin-bottom:6px;color:var(--text-muted);font-size:0.85rem">COST CENTERS</div>'
			);
			parts.push('<table class="table table-sm" style="margin:0;font-size:0.85rem">');
			parts.push(
				"<thead><tr><th>Cost Center</th><th>Group</th><th>Company</th><th>Actions</th></tr></thead><tbody>"
			);
		...
		if (c.orphan_projects.length) {
			parts.push('<div style="margin-bottom:10px">');
			parts.push(
				'<div style="font-weight:500;margin-bottom:6px;color:var(--text-muted);font-size:0.85rem">PROJECTS (not under a cost center)</div>'
			);
			parts.push('<table class="table table-sm" style="margin:0;font-size:0.85rem">');
			parts.push(
				"<thead><tr><th>Project</th><th>Company</th><th>Cost Center</th><th>Actions</th></tr></thead><tbody>"
		...
		if (c.orphan_depts.length) {
			parts.push('<div style="margin-bottom:10px">');
			parts.push(
				'<div style="font-weight:500;margin-bottom:6px;color:var(--text-muted);font-size:0.85rem">DEPARTMENTS (not under a cost center)</div>'
			);
			parts.push('<table class="table table-sm" style="margin:0;font-size:0.85rem">');
			parts.push(
				"<thead><tr><th>Department</th><th>Company</th><th>Cost Center</th><th>Actions</th></tr></thead><tbody>"
